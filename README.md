...
```
sudo apt install qtcreator qt6-base-dev build-essential wmctrl openbox picom alacritty g++ xserver-xephyr libx11-dev libxinerama-dev libxrandr-dev cmake make
```
